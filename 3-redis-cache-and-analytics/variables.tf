# variables.tf — parameterise subscription, location, Redis tier and the allowed IP.
...
variable "redis_sku_name" {
  description = "Azure Managed Redis SKU tier. Format: <Performance>_<Size>. Balanced_B0 is the smallest/cheapest tier suitable for lab use. Other examples: Balanced_B1, ComputeOptimized_X2, MemoryOptimized_M10."
  type        = string
  default     = "Balanced_B0"
}
